...
export const ProfileLink = ({ profile }: { profile: VenueProfile }) => {
  ...
  return (
    <div className="flex flex-row items-center gap-2 font-content text-sm text-highlight transition-transform duration-300 hover:translate-y-0.5 hover:brightness-125">
